...
participantes = ["Python", "Java", "C++", "JavaScript"]
...
for string in participantes:
    ...
    print(f"String: {string:<11} | Sorteada: {contagem[string]:>2} vezes | Chance Real: {frequencia_porcentagem:.1f}%")

# Chance teórica matemática
chance_teorica = (1 / len(participantes)) * 100
print(f"\n* A chance teórica exata para cada uma era de: {chance_teorica:.1f}%")
